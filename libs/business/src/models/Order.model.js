...
export class Order extends BaseModel {
  ...
  get orderDeliveryStateHistory() {
    return [...this.deliveryStateHistos]
      .sort(
        (a, b) =>
          new Date(b.updated ?? b.updatedAt) -
          new Date(a.updated ?? a.updatedAt)
      )
      .filter(d => d.deliveryState !== 'END');
  }
    ...
    return {
      [DELIVERY_MODES.MONDIAL_RELAY]: {
        [ORDER_STATES.ORDER_ACCEPTED]:
          ORDER_STATE_TRANSITIONS.ORDER_ACCEPTED_BY_SELLER,
        [ORDER_DELIVERY_STATES.DEPOSIT_PACKAGE_IN_PROGRESS]:
          ORDER_DELIVERY_STATE_TRANSITIONS.SEND,
        [ORDER_DELIVERY_STATES.SENT]:
      ...
      [DELIVERY_MODES.HAND]: {
        ...
        [ORDER_DELIVERY_STATES.START]: ORDER_DELIVERY_STATE_TRANSITIONS.SEND,
        [ORDER_DELIVERY_STATES.SENT]:
          ORDER_DELIVERY_STATE_TRANSITIONS.DELIVERY_BY_SENT,
        [ORDER_DELIVERY_STATES.DELIVERED]:
          ORDER_DELIVERY_STATE_TRANSITIONS.VALIDATION_BY_DELIVERED
      ...
      [DELIVERY_MODES.COLISSIMO]: {
        [ORDER_STATES.ORDER_ACCEPTED]:
          ORDER_STATE_TRANSITIONS.ORDER_ACCEPTED_BY_SELLER,
        [ORDER_DELIVERY_STATES.DEPOSIT_PACKAGE_IN_PROGRESS]:
          ORDER_STATE_TRANSITIONS.SEND,
        [ORDER_DELIVERY_STATES.SENT]: ORDER_STATE_TRANSITIONS.DELIVERY_BY_SENT,
        [ORDER_DELIVERY_STATES.DELIVERED]:
      ...
      [DELIVERY_MODES.LAPOSTE_COLISSIMO]: {
        ...
        [ORDER_DELIVERY_STATES.TRANSFER_TO_DESTINATION_MAILBOX_IN_PROGRESS]:
          ORDER_DELIVERY_STATE_TRANSITIONS.DELIVERY_TO_BUYER,
      ...
      [DELIVERY_MODES.LAPOSTE_LETTER]: {
        ...
        [ORDER_DELIVERY_STATES.DEPOSIT_IN_MAILBOX_BY_SELLER_IN_PROGRESS]:
          ORDER_DELIVERY_STATE_TRANSITIONS.DEPOSITED_IN_MAILBOX_BY_SELLER,
        [ORDER_DELIVERY_STATES.TRANSFERT_TO_POST_OFFICE_IN_PROGRESS]:
          ORDER_DELIVERY_STATE_TRANSITIONS.DELIVERY_TO_POST_OFFICE,
        [ORDER_DELIVERY_STATES.PACKAGE_VALIDATION_BY_BUYER_IN_PROGRESS]:
          ORDER_DELIVERY_STATE_TRANSITIONS.PACKAGE_VALIDATED_BY_BUYER
      },
      [DELIVERY_MODES.LOCATION]: {
        [ORDER_STATES.ORDER_ACCEPTED]:
          ORDER_STATE_TRANSITIONS.ORDER_ACCEPTED_BY_SELLER,
        [ORDER_DELIVERY_STATES.DEPOSIT_PACKAGE_IN_PROGRESS]:
          this.locationStoreType,
        [ORDER_DELIVERY_STATES.STORE_TO_STORE_VALIDATED]:
          ORDER_DELIVERY_STATE_TRANSITIONS.STORE_TO_STORE_TRANSIT,
        [ORDER_DELIVERY_STATES.STORE_TO_STORE_IN_TRANSIT]:
          ORDER_DELIVERY_STATE_TRANSITIONS.STORE_TO_STORE_DISTRIBUTION,
        [ORDER_DELIVERY_STATES.DISTRIBUTED]:
          ORDER_DELIVERY_STATE_TRANSITIONS.DELIVERY,
        [ORDER_DELIVERY_STATES.DELIVERED]:
          ORDER_DELIVERY_STATE_TRANSITIONS.VALIDATION_BY_DELIVERED
