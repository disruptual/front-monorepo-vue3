...
export const ORDER_ACTIONS = {
  CONFIRM_BY_SELLER: 'CONFIRM_BY_SELLER',
  CANCEL_BY_SELLER: 'CANCEL_BY_SELLER',
  MARK_AS_SENT: 'MARK_AS_SENT',
  SELECT_RELAY: 'SELECT_RELAY',
  PRINT_ETIQUETTE: 'PRINT_ETIQUETTE',
  SHOW_QRCODE: 'SHOW_QRCODE',
  MARK_AS_RECEIVED: 'MARK_AS_RECEIVED',
  VALIDATE_BY_BUYER: 'VALIDATE_BY_BUYER',
  INVALIDATE_BY_BUYER: 'INVALIDATE_BY_BUYER',
  MANAGE_REFUND_BY_BUYER: 'MANAGE_REFUND_BY_BUYER',
  OFFER_REFUND_BY_SELLER: 'OFFER_REFUND_BY_SELLER',
  GIVE_REVIEW: 'GIVE_REVIEW',
  SELECT_TYPE_OF_SENDING_BY_SELLER: 'SELECT_TYPE_OF_SENDING_BY_SELLER',
  REFUSE_REFUND_BY_BUYER: 'REFUSE_REFUND_BY_BUYER',
  ACCEPT_REFUND_BY_BUYER: 'ACCEPT_REFUND_BY_BUYER'
};
